  ...
  return (
    ...
    >
      <div className="transform-style-3d relative transition-transform duration-700">
        <div className="backface-hidden card absolute h-80 w-full border-2 border-base-content/10 bg-base-200 shadow-md">
        ...
        <div className="backface-hidden rotate-y-180 card absolute h-80 w-full border-2 border-base-content/10 bg-base-200 shadow-md">
